...
# data = np.load("C:/runs/logs/diffmodel/data/TS/2_LV_4cl_p_0.60_0.90_0.50_0.80_pn_0.03333_on_0.01000_tmax_5.npy", allow_pickle=True)[()]
...
class Toy_Dataset(Dataset):
    def __init__(self, eval_length=51, use_index_list=None, missing_ratio=0.1, seed=0):
        ...
        self.gt_masks = []
        # path = (
        #     "C:/runs/logs/diffmodel/data/toy_missing" + str(missing_ratio) + "_seed" + str(seed) + ".pk"
        # )
        path = (
